...
export const Card = ({
  ...
  return (
    <div
      onClick={() => navigate(path)} // Navega para o caminho definido no card
      className={`flex flex-col ${color} rounded-3xl p-6 shadow-lg h-full transition-all hover:scale-[1.02] active:scale-95 cursor-pointer border border-white/20`}
    >
